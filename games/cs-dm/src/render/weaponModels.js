...
const modelDefinitions = Object.freeze([
  ...
  createModel({
    ...
    worldParts: [
      ...
      { id: 'ak-trigger-guard', shape: 'box', material: 'dark-bore', size: vector(0.28, 0.08, 0.16), position: vector(0.18, -0.16, 0), rotation: vector(0, 0, -0.12) },
      { id: 'ak-rear-sight', shape: 'box', material: 'matte-gunmetal', size: vector(0.16, 0.12, 0.1), position: vector(0.28, 0.16, 0) },
      { id: 'ak-gas-block', shape: 'cylinder', material: 'matte-gunmetal', size: vector(0.13, 0.13, 0.16), position: vector(0.69, 0.04, 0), rotation: vector(0, 1.5708, 0) },
      { id: 'ak-magazine-spine', shape: 'box', material: 'matte-gunmetal', size: vector(0.08, 0.38, 0.2), position: vector(-0.06, -0.34, -0.1), rotation: vector(0, 0, 0.2) },
    ],
    viewmodelParts: [
      ...
      { id: 'vm-gas-block', shape: 'cylinder', material: 'matte-gunmetal', size: vector(0.13, 0.13, 0.16), position: vector(0.34, -0.16, -1.58), rotation: vector(1.5708, 0, 0) },
      { id: 'vm-trigger-guard', shape: 'box', material: 'dark-bore', size: vector(0.28, 0.1, 0.22), position: vector(0.4, -0.44, -0.28), rotation: vector(0, 0, 0.08) },
    ],
