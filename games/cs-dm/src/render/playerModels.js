...
export const PLAYER_MODEL_VARIANTS = freezeDeep({
  [PLAYER_MODEL_IDS.CT_RANGER]: {
    ...
    parts: [
      ...
      box('ct-left-shoulder-pad', 'armor-detail', { x: 0.22, y: 0.12, z: 0.38 }, { x: -0.58, y: 1.34, z: 0.02 }, 'gear', { rotation: { x: 0, y: 0, z: -0.12 } }),
      box('ct-right-shoulder-pad', 'armor-detail', { x: 0.22, y: 0.12, z: 0.38 }, { x: 0.58, y: 1.34, z: 0.02 }, 'gear', { rotation: { x: 0, y: 0, z: 0.12 } }),
      box('ct-left-ear-cup', 'headgear', { x: 0.1, y: 0.22, z: 0.22 }, { x: -0.28, y: 1.72, z: 0 }, 'helmet'),
      box('ct-right-ear-cup', 'headgear', { x: 0.1, y: 0.22, z: 0.22 }, { x: 0.28, y: 1.72, z: 0 }, 'helmet'),
      box('ct-left-chest-pouch', 'armor-detail', { x: 0.2, y: 0.22, z: 0.12 }, { x: -0.28, y: 1.03, z: 0.25 }, 'accent'),
      box('ct-right-chest-pouch', 'armor-detail', { x: 0.2, y: 0.22, z: 0.12 }, { x: 0.28, y: 1.03, z: 0.25 }, 'accent'),
      box('ct-left-thigh-pouch', 'armor-detail', { x: 0.14, y: 0.28, z: 0.12 }, { x: -0.28, y: 0.48, z: 0.2 }, 'gear'),
      box('ct-right-thigh-pouch', 'armor-detail', { x: 0.14, y: 0.28, z: 0.12 }, { x: 0.28, y: 0.48, z: 0.2 }, 'gear'),
    ],
  },
  [PLAYER_MODEL_IDS.T_RAIDER]: {
    ...
    parts: [
      ...
      box('t-head-wrap-side', 'headgear', { x: 0.52, y: 0.08, z: 0.1 }, { x: 0, y: 1.77, z: -0.2 }, 'jacket'),
      box('t-left-chest-pouch', 'gear', { x: 0.2, y: 0.22, z: 0.12 }, { x: -0.28, y: 1.02, z: 0.25 }, 'pack'),
      box('t-right-chest-pouch', 'gear', { x: 0.2, y: 0.22, z: 0.12 }, { x: 0.28, y: 1.02, z: 0.25 }, 'pack'),
      box('t-left-elbow-wrap', 'arms', { x: 0.24, y: 0.14, z: 0.24 }, { x: -0.58, y: 0.82, z: 0.14 }, 'sash'),
      box('t-right-elbow-wrap', 'arms', { x: 0.24, y: 0.14, z: 0.24 }, { x: 0.58, y: 0.82, z: 0.14 }, 'sash'),
      box('t-left-boot-wrap', 'boots', { x: 0.32, y: 0.12, z: 0.38 }, { x: -0.22, y: 0.18, z: 0.02 }, 'pack'),
      box('t-right-boot-wrap', 'boots', { x: 0.32, y: 0.12, z: 0.38 }, { x: 0.22, y: 0.18, z: 0.02 }, 'pack'),
    ],
  },
});
