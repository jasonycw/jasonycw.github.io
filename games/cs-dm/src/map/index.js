...
export const MAP_GEOMETRY_PRIMITIVES = Object.freeze([
  ...
  Object.freeze({ id: 'mid-approach-door-left', kind: 'door-panel', material: MAP_MATERIALS.METAL.id, visualRole: 'doors', footprint: freezeBox(22.25, 2.1, 72, 4.2, 4.2, 0.55) }),
  Object.freeze({ id: 'mid-approach-door-right', kind: 'door-panel', material: MAP_MATERIALS.METAL.id, visualRole: 'doors', footprint: freezeBox(27.75, 2.1, 72, 4.2, 4.2, 0.55) }),
  ...
  Object.freeze({ id: 'mid-doors', kind: 'doorframe', material: MAP_MATERIALS.SANDSTONE.id, visualRole: 'doors', footprint: freezeBox(56, 0, 50, 4, 5, 14) }),
  Object.freeze({ id: 'mid-doors-left', kind: 'door-panel', material: MAP_MATERIALS.METAL.id, visualRole: 'doors', footprint: freezeBox(56, 2.5, 46.5, 0.6, 5, 7) }),
  Object.freeze({ id: 'mid-doors-right', kind: 'door-panel', material: MAP_MATERIALS.METAL.id, visualRole: 'doors', footprint: freezeBox(56, 2.5, 53.5, 0.6, 5, 7) }),
  Object.freeze({ id: 'xbox-crate', kind: 'cover', material: MAP_MATERIALS.WOOD.id, visualRole: 'crates', footprint: freezeBox(54, 1.2, 58, 2.4, 2.4, 2.4) }),
  Object.freeze({ id: 'catwalk-ledge', kind: 'ledge', material: MAP_MATERIALS.CONCRETE.id, visualRole: 'ledges', footprint: freezeBox(68, 3, 50, 10, 0.8, 24) }),
