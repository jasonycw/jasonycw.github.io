...
// Camera setup (Orthographic for 2.5D effect)
...
let lastFrameTime = performance.now(); // Gemini Feedback: Use performance.now()
...
document.addEventListener('mousedown', (event) => {
    ...
    // Gemini Feedback: Correct raycasting intersection check
...
console.log('Typhoon Tycoon 2.5D (Manus Edition) initialized.');
