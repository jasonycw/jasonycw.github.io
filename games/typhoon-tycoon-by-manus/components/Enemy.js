...
export class Enemy {
    constructor(scene, path, waveNumber = 1) {
        ...
        this.pathIndex = 0;
        this.progress = 0; // Progress between current and next waypoint (0 to 1)
        this.alive = true;
        ...
        // Cache segment length for performance (Gemini Feedback)
    ...
    update(deltaTime, camera) {
        ...
        // Billboard effect for health bar (Gemini Feedback)
        if (camera) {
